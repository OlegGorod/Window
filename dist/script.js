...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var callEngineerBtn = document.querySelectorAll(triggerSelector);
    var modalEngineer = document.querySelector(modalSelector);
    var modalEngineerClose = document.querySelector(closeSelector);
    callEngineerBtn.forEach(function (item) {
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); // showModalByTime('.popup',500000000);
};
