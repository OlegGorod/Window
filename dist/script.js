...
/* harmony import */ var _modules_dataFromCalc__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/dataFromCalc */ "./src/js/modules/dataFromCalc.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var dataState = {};
  Object(_modules_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_modal_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(dataState);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_dataFromCalc__WEBPACK_IMPORTED_MODULE_6__["default"])(dataState);
...
var checkNumInputs = function checkNumInputs(selector) {
  var inputNum = document.querySelectorAll(selector);
...
/***/ "./src/js/modules/dataFromCalc.js":
/*!****************************************!*\
  !*** ./src/js/modules/dataFromCalc.js ***!
  \****************************************/
/*! exports provided: default */
...
var dataFromCalc = function dataFromCalc(state) {
  var formWindow = document.querySelectorAll('.balcon_icons_img');
  var widthWindow = document.querySelector('#width');
  var heightWindow = document.querySelector('#height');
  var typeWindow = document.querySelectorAll('#view_type');
  var checkboxWindow = document.querySelectorAll('.checkbox');
  ...
  function form(window) {
    formWindow.forEach(function (item, i) {
  ...
  function type(window) {
    typeWindow.forEach(function (item, i) {
  ...
  function profile(window) {
    checkboxWindow.forEach(function (item) {
...
/* harmony default export */ __webpack_exports__["default"] = (dataFromCalc);
...
var images = function images() {
  var headerImg = document.querySelector('.works');
...
var timer = function timer() {
  ...
  var deadline = '1 Jan 2025';

  function runningTimer() {
    var newDate = new Date(deadline);
  ...
  var timeinterval = setInterval(runningTimer, 1000);
  runningTimer();
};
